        ...
        <Container>
          <Row>
            <Col md={6}>
              <h1>About Us</h1>
              <p>
                Welcome to our Crop Yield Prediction and Fertilizer
                Recommendation website! We are a team of agricultural
        ...
        <Container>
          <Row>
            ...
            <Col md={6}>
              <h2>Our Mission</h2>
              <p>
                At QuickCrop, our mission is to help farmers maximize their crop
